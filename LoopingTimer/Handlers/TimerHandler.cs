...
public class TimerHandler
{
	...
	private static async void onSetInterval(MessageDetails messageDetails)
	{
		...
		SendMessageEvent?.Invoke(messageDetails.chatId, inlineKeyboard, "Timer has been scheduled");
	}
